...
profiles.each do |profile|
  ...
  profile.user.todo_lists.create!(list_name: "#{profile.first_name}'s list", list_due_date: due_date)

  5.times do
    profile.user.todo_lists.last.todo_items.create!(due_date: due_date, title: "title", description: "short description")
  end
end
